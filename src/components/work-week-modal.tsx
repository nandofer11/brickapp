...
//     try {
//       setIsLoading(true)
//       const res = await fetch(`/api/semana_laboral?id_empresa=${id_empresa}`)
//       const data = await res.json()

//       // Filtrar las semanas por empresa y asegurar que tengan todos los campos necesarios
//       const filteredData = data
//         .filter((week: WorkWeek) => week.id_empresa === id_empresa)
//         .map((week: WorkWeek) => ({
//           id_semana_trabajo: week.id_semana_trabajo,
//           fecha_inicio: week.fecha_inicio,
//           fecha_fin: week.fecha_fin,
//           estado: week.estado,
//           id_empresa: week.id_empresa,
//         }))
//         .sort((a: WorkWeek, b: WorkWeek) => {
//           return new Date(a.fecha_inicio).getTime() - new Date(b.fecha_inicio).getTime()
//         })

//       setSemanas(filteredData)
//     } catch (error) {
...
//       setSemanas((prevSemanas) => prevSemanas.filter((week) => week.id_semana_trabajo !== deleteId)) // Actualizar estado local
...
//           ? error.message
//           : "No se pudo eliminar la semana laboral"
//       )
//     } finally {
//       setIsDeleting(false)
//       setDeleteId(null)
...
//       // Capturar la respuesta que debe incluir el id_semana_trabajo
//       const savedWeek = await res.json()
      
//       // Actualizar el estado local con la nueva semana que incluye el id_semana_trabajo
//       setSemanas(prev => {
//         if (editMode) {
//           return prev.map(week => 
//             week.id_semana_trabajo === values.id_semana_trabajo ? savedWeek : week
//           )
//         } else {
//           return [...prev, savedWeek]
//         }
//       })
